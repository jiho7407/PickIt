...
- `get_my_notification_candidates()` 기반 내 투표 결과 알림 후보
- `get_my_notification_candidates()` 기반 내 7일 후 회고 알림 후보
- 운영자 전체 후보 조회는 `get_operator_notification_candidates()`와 운영 스크립트/후속 관리자 UI가 담당한다.
